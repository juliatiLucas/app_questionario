        ...
        child: Row(
          ...
          children: [
            Container(
              ...
              height: 25,
              decoration:
                  BoxDecoration(color: resposta.pergunta.questionario.cor, borderRadius: BorderRadius.all(Radius.circular(2.5))),
            ),
            Container(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Opacity(
                      opacity: 0.8,
                      child: Text("Resposta: " + (resposta.resposta.length > 0 ? resposta.resposta : resposta?.opcao?.opcao),
